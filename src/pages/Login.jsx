...
const Login = () => {
  ...
  return (
    <div className="flex justify-center">
      <div
        className="form-image hidden md:block 
      "
      >
        <img
      ...
      <div className="overflow-hidden flex-1 h-screen justify-center items-center bg-[#23242a]">
        <div
          className={`mt-[10vh] mx-auto overflow-hidden relative w-[380px] h-[5000px] rounded-[8px] bg-[#1c1c1c] before:content-[""] before:absolute before:w-[380px] before:h-[380px] before:top-[-50%] before:left-[-50%] after:content-[""] after:absolute after:w-[380px] after:h-[420px] after:top-[-50%] after:left-[-50%] custom-linear-gradient`}
        >
          <form
          ...
          >
            ...
            <div className="flex justify-between">
              <span
                role="button"
                className="cursor-pointer decoration-none text-[#8f8f8f] font-[0.45rem] links-a"
              >
                Forget Password
              </span>
              <Link
